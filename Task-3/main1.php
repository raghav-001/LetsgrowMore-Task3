...
<body style="background-color:rgb(175,178,189)">
        ...
        <div class="container">
             <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                <ul class="navbar-nav mr-auto smooth-scroll">
                    <li class="nav-item"><a class="nav-link" href="homepage2.php">Home</a></li>
      ...
      <div class="main">
		  ...
		  for($j=0;$j<$i;$j++)
		  {
				echo'<table border=1 height=150px width=500px>
				<tr>
				...
				<td><h5>';echo $classinfo[$j]['mark1']; echo'</h5></td>
				</tr>
				<tr>
				<td><h5><b>Half yearly exam</b></h5></td>
				<td><h5>';echo $classinfo[$j]['mark2']; echo'</h5></td>
				</tr>
				<tr>
				<td><h5><b>Final Assessment</h5></b></td>
				<td><h5>';echo $classinfo[$j]['mark3']; echo'</h5></td>
				</tr>
				</table><br>';
		  }
		  ?>

...
<body style="background-color:rgb(175,178,189)">
      ...
      <div class="main">
		  ...
		  for($j=0;$j<$i;$j++)
		  {
				...
				<td><h5>';echo $classinfo[$j]['courseclassnumber'];echo '</h5></td>
				</tr>
				...
				<tr>
				<td colspan=2><center><button name="clsnum" value='.$classinfo[$j]['courseclassnumber'].'>View students</button></center>
				</td></tr>
				</table><br>';
		  }
		  ?>
